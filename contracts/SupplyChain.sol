...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  modifier isOwner() {
    require(msg.sender == owner, 'This method can only be executed by the contract owner!');
    _;
  }
...
// todo: tests
  ...
  function addItem(string memory _name, uint _price) public returns(bool){
    ...
    skuCount = skuCount + 1;
    // Moved log below here because the local state must be updated before emitting events to external systems (and facilitate reentrancy attacks)
